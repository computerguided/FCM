...
_The Functional Components Method can be used to specify the software of a device. This document gives some guidelines on how to do this._

## Use cases

Based on the required functionality, the system has to achieve certain _objectives_.
...
To achieve a certain objective, some _actors_ are involved. An _actor_ is an entity that can act on the system. Examples of actors are:
...
The objective and the list of involved actors define the _use-case_.
...
To define which actors are involved in which use-cases and the dependencies between these use cases a _use-case diagram_ is used. 
...
Some attributes of the functional component are used inside state transition and evaluation functions. Those specific attributes are called _state-variables_ as these can be technically seen as holding a kind of 'sub-state' of the component and influence the behavior of the component.
